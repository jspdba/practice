            ...
            <div class="box box-warning">
                ...
                <form role="form" action="/auth/role/save.action" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <textarea id="description" name="description" class="form-control" rows="3" placeholder="角色描述"></textarea>
                        </div>
                    </div>
...
<script>
        ...
        var oTable = $('#dataTable').dataTable(
            {
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    $('td:eq(0)', nRow).html("<div style='width: 10px'><a href='/auth/role/edit.action?id=" + aData.id + "'>" + (iDisplayIndex + 1) + "</a></div>");
                    $('td:eq(1)', nRow).html("<div style='width: 70px'>" + aData.rolename + "</div>");
                    $('td:eq(2)', nRow).html("<div style='width: 120px'>" + aData.description + "</div>");
    ...
    $(document).on("click",".del",function () {
        ...
        var url="/auth/role/delete.action";
