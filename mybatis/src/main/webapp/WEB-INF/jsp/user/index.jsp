...
<script>
        ...
        var oTable = $('#dataTable').dataTable(
            {
                ...
                "fnRowCallback": function(nRow, aData, iDisplayIndex) {
                    ...
                    $('td:eq(1)', nRow).html("<div style='width: 70px'>"+(aData.username?aData.username:"")+"</div>");
                    var roles,result=aData.roleList;
                    ...
                    $('td:eq(2)', nRow).html("<div style='width: 70px'>"+(roles?roles:"")+"</div>");
                    return nRow;
                },
    ...
    $(document).on("click",".selectRole",function () {
        ...
        var url="/user/selectRoleByUserId";
        //根据用户获取角色
    ...
    function selectRole(){
        ...
        layer.confirm("确定操作？",function(){
            <%--loding--%>
            var load = layer.load();
            $.post('/user/addRole2User.action',{ids:ids.join(','),userId:userId},function(result){
                layer.close(load);
